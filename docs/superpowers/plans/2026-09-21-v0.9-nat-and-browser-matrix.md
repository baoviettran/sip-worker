...
In `README.md`'s `## Project` section, add a line linking the page and list the three new scripts with what they do:
...
Run: `npm run test:docs`
Expected: PASS — the new README link resolves to a committed file, and every documented script exists in the root manifest.
