...
no WebRTC. The real WebRTC audio surface lives in the browser `sip-worker`
package. It makes no production-readiness claim. See the migration guides for
the 0.2.0 to 0.3.0 mapping:
